...
@section('content')
    <form action="{{ route('direcao.professores.update', $professor) }}" method="POST" class="form-card form-card--narrow">
        ...
        <section class="form-section"><div class="form-grid">
            ...
            <div class="field"><label for="password">Nova senha</label><input type="password" id="password" name="password" autocomplete="new-password"><span class="field__hint">Deixe em branco para manter a senha atual. Novas senhas exigem no mínimo 6 caracteres.</span></div>
